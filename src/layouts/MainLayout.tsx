...
import { Leaf, Globe, Menu, ArrowRight, ShoppingCart } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-50 flex flex-col font-sans selection:bg-zinc-500/30 relative overflow-hidden">
      ...
      <footer className="border-t border-zinc-800/50 bg-zinc-950/80 py-16 relative z-10 overflow-hidden">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-3xl h-[1px] bg-gradient-to-r from-transparent via-zinc-500/50 to-transparent"></div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-6 gap-8 lg:gap-12 mb-12">
            <div className="col-span-2 md:col-span-6 lg:col-span-2">
              <Link to="/" className="flex items-center gap-2 mb-4 group">
                <Leaf className="w-6 h-6 text-zinc-500 group-hover:rotate-12 transition-transform" />
              ...
              <div className="mb-6">
                ...
                <form className="flex gap-2" onSubmit={(e) => e.preventDefault()}>
                  <input type="email" placeholder="Enter your email" className="h-10 px-3 rounded-lg bg-zinc-900 border border-zinc-800 text-sm text-white focus:outline-none focus:border-zinc-500 w-full" />
                  <button className="h-10 px-3 rounded-lg bg-zinc-500 text-zinc-950 font-bold hover:bg-zinc-400 transition-colors active:scale-95 flex items-center justify-center shrink-0">
              ...
              <div className="flex gap-4">
                <a href="#" className="w-8 h-8 rounded-full bg-zinc-900 border border-zinc-800 flex items-center justify-center text-zinc-400 hover:text-zinc-400 hover:border-zinc-500/50 transition-all">
            ...
            <div className="col-span-1 lg:col-span-1">
              ...
              <ul className="space-y-3 text-sm text-zinc-400">
                <li><Link to="#features" className="hover:text-zinc-400 transition-colors">Features</Link></li>
                <li><Link to="/dashboard" className="hover:text-zinc-400 transition-colors">ESG Dashboard</Link></li>
                <li><Link to="/extension" className="hover:text-zinc-400 transition-colors">Browser Extension</Link></li>
                <li><Link to="#pricing" className="hover:text-zinc-400 transition-colors">Pricing</Link></li>
              </ul>
            </div>
            ...
            <div className="col-span-1 lg:col-span-1">
              ...
              <ul className="space-y-3 text-sm text-zinc-400">
                <li><Link to="/api" className="hover:text-zinc-400 transition-colors">CarbonIQ API</Link></li>
                <li><a href="#" className="hover:text-zinc-400 transition-colors">Documentation</a></li>
                <li><a href="#" className="hover:text-zinc-400 transition-colors">LCA Database</a></li>
                <li><a href="#" className="hover:text-zinc-400 transition-colors">GitHub Repo</a></li>
              </ul>
            </div>
            ...
            <div className="col-span-1 lg:col-span-1">
              ...
              <ul className="space-y-3 text-sm text-zinc-400">
                <li><Link to="/about" className="hover:text-zinc-400 transition-colors">About Us</Link></li>
                <li><a href="#" className="hover:text-zinc-400 transition-colors">Enterprise</a></li>
                <li><a href="#" className="hover:text-zinc-400 transition-colors">Partners</a></li>
                <li><a href="#" className="hover:text-zinc-400 transition-colors">Contact Sales</a></li>
              </ul>
            </div>
            ...
            <div className="col-span-1 lg:col-span-1">
              ...
              <ul className="space-y-3 text-sm text-zinc-400">
                <li><a href="#" className="hover:text-zinc-400 transition-colors">Privacy Policy</a></li>
                <li><a href="#" className="hover:text-zinc-400 transition-colors">Terms of Service</a></li>
                <li><a href="#" className="hover:text-zinc-400 transition-colors">Security</a></li>
              </ul>
            </div>
          </div>
