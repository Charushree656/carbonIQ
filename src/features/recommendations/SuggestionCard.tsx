...
export function SuggestionCard({ recommendation, onReplace }: SuggestionCardProps) {
  return (
    <motion.div 
      ...
      className="p-4 bg-gradient-to-r from-zinc-950/30 to-zinc-950 border border-zinc-900/50 rounded-xl mb-4"
    >
      <div className="flex items-start justify-between mb-3">
        <div className="flex items-center gap-2 text-zinc-900 dark:text-white text-sm font-semibold">
      ...
      <div className="flex items-center justify-between mt-2">
        <div className="flex items-center gap-3">
           <div className="w-10 h-10 rounded-lg bg-zinc-950 border border-zinc-900 flex items-center justify-center text-xl">
           ...
           <div>
             ...
             <p className="text-zinc-900 dark:text-white text-xs font-medium">Save {recommendation.carbonSaved.toFixed(1)} kg CO₂</p>
           </div>
        </div>
        ...
        <Button 
          ...
          className="bg-zinc-600 hover:bg-zinc-900 dark:bg-white text-white dark:text-zinc-950 text-white rounded-full text-xs font-semibold"
        >
