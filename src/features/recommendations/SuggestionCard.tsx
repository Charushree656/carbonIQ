...
export function SuggestionCard({ recommendation, onReplace }: SuggestionCardProps) {
  return (
    <motion.div 
      ...
      className="relative p-4 bg-zinc-900/60 border border-zinc-800 rounded-xl mb-4 overflow-hidden group hover:border-emerald-500/30 transition-all duration-300"
    >
      ...
      <div className="relative flex items-center justify-between mt-2">
        <div className="flex items-center gap-3">
           <div className="w-10 h-10 rounded-lg bg-zinc-950 border border-zinc-800 flex items-center justify-center text-xl shadow-inner">
           ...
           <div>
             ...
             <p className="text-emerald-500 text-xs font-semibold mt-0.5">Save {recommendation.carbonSaved.toFixed(1)} kg CO₂</p>
           </div>
        </div>
        ...
        <Button 
          ...
          className="bg-emerald-600 hover:bg-emerald-500 text-white rounded-full text-xs font-bold px-4 transition-all active:scale-95"
        >
